...
from level3 import create_level_3
...
pygame.display.set_caption("Safe Encounters - Path")
music_paused = False
# Colors
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
...
def inbetween_slide():
    ...
    while True:
        ...
        draw_text("LEVEL 3: HIDDEN HAZARDS", bold_font, BLACK, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 200)
        
        # Add more elements and interactivity as needed
        create_button("LEVEL 3",  SCREEN_WIDTH // 2 -160, SCREEN_HEIGHT // 2 + 10  , 300, 75, bold_font, (0,43,128), (25,217,255))
