...
from fourth_slide3 import create_fourth_slide
# Initialize Pygame
pygame.init()
mixer.init()
# Screen dimensions
...
def create_third_slide():
    ...
    while True:
        ...
        draw_text("LEVEL 1: SAFE STORAGE", bold_font, BLACK, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 100)
        ...
        create_button("PLAY",  SCREEN_WIDTH // 2 - 150, SCREEN_HEIGHT // 2 + 220  , 300, 75, bold_font, (0,43,128), (25,217,255))
        # Update the display
        pygame.display.flip()
